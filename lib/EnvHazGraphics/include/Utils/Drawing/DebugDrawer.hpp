...
private:
  ...
  static constexpr GLuint sphereIndices[] = {
      0,  13, 12, 1,  13, 15, 0,  12, 17, 0,  17, 19, 0,  19, 16, 1,  15, 22,
      2,  14, 24, 3,  18, 26, 4,  20, 28, 5,  21, 30, 1,  22, 25, 2,  24, 27,
      3,  26, 29, 4,  28, 31, 5,  30, 23, 6,  32, 37, 7,  33, 39, 8,  34, 40,
      9,  35, 41, 10, 36, 38, 38, 41, 11, 38, 37, 41, 37, 10, 41, 41, 40, 11,
      41, 36, 40, 36, 9,  40, 40, 39, 11, 40, 35, 39, 35, 8,  39, 39, 38, 11,
      39, 32, 38, 32, 10, 38, 23, 36, 10, 23, 30, 36, 30, 9,  36, 31, 35, 9,
      31, 28, 35, 28, 8,  35, 27, 34, 8,  27, 25, 34, 25, 7,  34, 26, 33, 6,
      26, 22, 33, 22, 1,  33, 30, 31, 10, 30, 23, 31, 23, 5,  31, 28, 29, 9,
      28, 21, 29, 21, 4,  29, 27, 28, 8,  27, 19, 28, 19, 3,  28, 25, 26, 6,
      25, 14, 26, 14, 1,  26, 22, 23, 11, 22, 15, 23, 15, 5,  23, 16, 22, 5,
      16, 19, 22, 19, 4,  22, 19, 21, 4,  19, 17, 21, 17, 3,  21, 17, 18, 3,
      17, 12, 18, 12, 2,  18, 16, 17, 5,  16, 14, 17, 14, 0,  17, 12, 13, 2,
      12, 14, 13, 14, 1,  13};
};
} // namespace eHazGraphics
